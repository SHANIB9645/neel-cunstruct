  ...
  return (
    <div className="p-4 rounded-[10px] bg-[#d9d9d903] border border-[#ffffff1a] h-full">
      ...
      <div className="flex items-end border-b border-[#ffffff1a]">
        <div className="w-13 ms-5 bg-gradient-to-t from-[#543F09] to-[#EAAB08] min-h-[250px] rounded-t-[10px] submitted_shadow" ></div>
        <div className="w-13  ms-5 bg-gradient-to-t from-[#073C21] to-[#00A653] h-[200px] rounded-t-[10px] recieve_shadow"></div>
        <div className="ms-14">
